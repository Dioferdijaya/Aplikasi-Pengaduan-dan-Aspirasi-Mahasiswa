...
<body>
    <div class="container">
        ...
        <form method="POST" action="{{ route('user.kirimPesan') }}" enctype="multipart/form-data">
            @csrf
            <div class="form-section">
                <label for="from">From :</label>
                <select id="from" name="from">
                    <option value= {{$user->nama_lengkap}} >{{ $user->nama_lengkap ?? 'User' }}</option>
                    <option value="anonymus">{{ 'anonymus' }}</option>
                </select>
            </div>
            <div class="form-section">
                <label for="to">To :</label>
                <select id="to" name="tujuan">
